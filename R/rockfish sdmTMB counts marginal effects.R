...
ggsave(filename = "Figures/Depth smoothers.jpeg",dpi=600,units="in",height=5,width=7)

# g <- ggeffect(fit_sdm, terms = c("log_depth [0:6.5 by=0.25]","depth_cat"))
# plot(g,facet=TRUE)
# 
# protection_effect <- ggeffects::ggeffect(fit_sdm, terms = c("protection_dist_scale [-2:2 by=0.5]"))
# plot(protection_effect)
